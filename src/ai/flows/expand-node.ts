...
export async function expandNode(input: ExpandNodeInput): Promise<ExpandNodeOutput> {
...
const prompt = ai.definePrompt({
    ...
    prompt: `You are an expert educator and content synthesizer. Your task is to expand a specific node within a mind map by generating detailed sub-categories.
