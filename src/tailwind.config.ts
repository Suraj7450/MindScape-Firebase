  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 15px -3px hsl(var(--primary) / 0.3), 0 0 6px -2px hsl(var(--primary) / 0.15)',
      },
      keyframes: {
        'accordion-down': {
          from: {
      ...
      animation: {
        ...
        'heartbeat-pulse-grow': 'heartbeat-pulse-grow 4s ease-in-out infinite',
      },
    },
  },
  plugins: [
